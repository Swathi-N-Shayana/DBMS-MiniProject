...
<div class="w3-top bgimg-1">
  <div class="w3-bar w3-white w3-card" id="myNavbar">
    ...
    <div class="w3-hide-small">
      ...
      <div class="w3-dropdown-content w3-round-large w3-bar-block w3-card-4">
...
<div class = "w3-container w3-middle w3-padding">
	...
	<form autocomplete="off" class="w3-round-large" method=POST action="LookUp.php">
		<div class="autocomplete">
			<input id="myInput" type="text" name="Faculty" placeholder="Faculty Name"  class="w3-round-large w3-white w3-padding w3-large w3-margin-top w3-opacity" ></div><br>
		<div class="autocomplete">
			<input id="myInput1" type="text" name="Day" placeholder="Day"  class="w3-round-large w3-white w3-padding w3-large w3-margin-top w3-opacity" ></div><br>
		<div class="autocomplete">
