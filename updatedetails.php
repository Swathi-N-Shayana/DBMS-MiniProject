...
$row2 = mysqli_fetch_array($result2);
 ...
 {?>
  <div class = "w3-container w3-left w3-padding">
	...
	<form class="w3-round-large" method=POST action="updatefaculty.php?uname=faculty&who=<?php echo "$who"?>">
		<input id="myInput" type="text" name="Name" placeholder="Faculty Name" value = "<?php echo $row1["Name"]?>" class="w3-round-large w3-white w3-padding w3-large w3-margin-top w3-opacity" readonly>
		<br>
 ...
 <?php }
	...
	<form class="w3-round-large" method=POST action="updatestudent.php?uname=student&who=<?php echo "$who"?>">
		<input id="myInput" type="text" name="Name" placeholder="Student Name" value = "<?php echo $row2["Name"]?>" class="w3-round-large w3-white w3-padding w3-large w3-margin-top w3-opacity" readonly>
		<br>
