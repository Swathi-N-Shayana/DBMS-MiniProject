...
<div class = "w3-container w3-left w3-padding">
	...
	<form autocomplete="off" class="w3-round-large" method=POST action="lookup.php?who=admin&name=<?php echo "$admin" ?>">
...
<div class = "w3-container w3-right w3-padding">
	<h1> Facutly Personal TimeTable</h1>
	<form autocomplete="off" class="w3-round-large" method=GET action="displayptt.php">
		<div class="autocomplete">
	    ...
	    <br>
		<input type="submit" name="LookUp" placeholder="View" value="Lookup" class="w3-button w3-round-large w3-white w3-padding w3-large w3-margin-top w3-opacity w3-hover-opacity-off">
	</form>
</div>	
</div>
</body>
