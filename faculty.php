...
$facultyname = $_GET["uname"];
?>
<html>
<title><?php echo "$facultyname" ?></title>
<meta charset="UTF-8">
...
<div class="w3-top bgimg-1">
  <div class="w3-bar w3-white w3-card" id="myNavbar">
    <a href="#home" class="w3-bar-item w3-button w3-wide">Hello <?php echo "$facultyname" ?></a>
		<div class="w3-hide-small">
      <a href="displayptt.php?name=<?php echo "$facultyname"?>" class="w3-bar-item w3-button" >MY TIME TABLE</a>
	  ...
	  <a href="updatedetails.php?name=<?php echo "$facultyname"?>&who=faculty" class="w3-bar-item w3-button" >MODIFY</a>
    </div>
...
<div class = "w3-container w3-middle w3-padding">
	...
	<form autocomplete="off" class="w3-round-large" method=POST action="lookup.php?who=faculty&name=<?php echo "$facultyname" ?>">
